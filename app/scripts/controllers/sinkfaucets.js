...
angular.module('myBathroomApp')
  .controller('SinkfaucetsCtrl', function ($scope,$http,$q,$cookies,$cookieStore,$location,$timeout,products,ngDialog) {
    $scope.awesomeThings = [
      'HTML5 Boilerplate',
      'AngularJS',
      'Karma'
...
$.each(products_cat,function(data1,val1){
  ...
  $scope.$apply();
    ...
    console.log(setres);
    $cookieStore.put('Sinkfaucet', $scope.prod);
    $(".ngdialog-overlay").click();
    $location.path("/shower");
