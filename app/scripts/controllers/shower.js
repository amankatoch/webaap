...
angular.module('myBathroomApp')
  .controller('ShowerCtrl', function ($scope,$http,$q,$cookies,$cookieStore,$location,$timeout,products,ngDialog) {
    $scope.awesomeThings = [
      'HTML5 Boilerplate',
      'AngularJS',
      'Karma'
...
$.each(products_cat,function(data1,val1){
  ...
  $scope.$apply();
    ...
    console.log(setres);
    $cookieStore.put('Shower', $scope.prod);
    $(".ngdialog-overlay").click();
    $location.path("/showerenclosure");
